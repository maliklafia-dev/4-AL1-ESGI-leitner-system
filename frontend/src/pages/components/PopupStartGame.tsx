...
function PopupStartGame() {
  ...
  return (
    <Box className={style.styleBox}>
      <Typography className={style.styleTypograpgy}>Question :</Typography>
      <Grid2 className={style.styleGridQuestion}>{question}</Grid2>
      <Typography className={style.styleTypograpgy}>Response :</Typography>
